 ...
 * @author Yuki
 */
public class listdatajenisbarang extends javax.swing.JFrame {
private Connection conn = new koneksi().connect();
    private DefaultTableModel tabmode;
    /**
     * Creates new form listdatabarang
     */
    public listdatajenisbarang() {
        initComponents();
        setLocationRelativeTo(null);
        setTitle("List Data Jenis Barang");
        datatable();
    }
public void datatable() {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("LIST DATA JENIS BARANG");
...
String barang = table.getValueAt(selectedRow, 1).toString(); 
...
fb.setKodeBarang(kodebarang);
fb.setKodeJenisBarang(barang);
fb.setNamaJenisBarang(jenisbarang);
