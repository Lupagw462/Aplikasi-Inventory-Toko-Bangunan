...
String Tanggal;
    ...
    try {
        ...
        if (hasil.next()) {
            ...
            String BM = String.valueOf(newNumber);
            ...
            ttransaksi.setText("BM" + Nol + BM);  // Ganti "TR" menjadi "BM"
        } else {
            ttransaksi.setText("BM0001");  // Ganti "TR0001" menjadi "BM0001"
        }
    } catch (NumberFormatException e) {
        System.out.println("Error parsing NoFaktur to number: " + e.getMessage());
        ttransaksi.setText("BM0001");
...
public void setDistributor(String distributor) {
    tidDST.setText(distributor);
}
public void setNama(String nama) {
    namaDST.setText(nama);
}
...
public void clear () {
    ...
    private void initComponents() {
        ...
        tidDST = new javax.swing.JTextField();
        namaDST = new javax.swing.JTextField();
        bDST = new javax.swing.JButton();
        ...
        bDST.setText("....");
        bDST.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bDSTActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(tidDST, javax.swing.GroupLayout.PREFERRED_SIZE, 127, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(bDST, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(jLabel5))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel6)
                    .addComponent(namaDST, javax.swing.GroupLayout.PREFERRED_SIZE, 145, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18))
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(tidDST, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(namaDST, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(bDST))
                .addContainerGap())
        );
    ...
    private void bDSTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bDSTActionPerformed
        // TODO add your handling code here:
        listdistributor a = new listdistributor();
        a.setVisible(true);
        dispose();
    }//GEN-LAST:event_bDSTActionPerformed
...
// Memformat harga dan total: jika bulat, tampilkan tanpa desimal, jika ada desimal, tampilkan dengan dua angka desimal
String hargaFormatted;
String totalFormatted;

if (harga == Math.floor(harga)) {
    hargaFormatted = String.format("%.0f", harga);  // Format tanpa desimal
} else {
    hargaFormatted = String.format("%.2f", harga);  // Format dengan dua desimal
}

if (total == Math.floor(total)) {
    totalFormatted = String.format("%.0f", total);  // Format tanpa desimal
} else {
    totalFormatted = String.format("%.2f", total);  // Format dengan dua desimal
}
...
String idDST = tidDST.getText();         // idDST
String nama = namaDST.getText();      // NamaDST
...
String sql = "INSERT INTO barangmasuk(NoFaktur, Tanggal, idDST, NamaDST, Total) VALUES(?, ?, ?, ?, ?)";
...
try {
    ...
    stat.setString(3, idDST);
    stat.setString(4, nama);
    stat.setDouble(5, total);

    int result = stat.executeUpdate();
    if (result > 0) {
        JOptionPane.showMessageDialog(null, "Barang Masuk Berhasil Disimpan", "Notice!!!", WIDTH, iconsukses);
    } else {
         JOptionPane.showMessageDialog(null, "Barang Masuk Gagal Disimpan", "Notice!!!", WIDTH, iconfailed);
        conn.rollback();
        return;
    }
    ...
    sql = "INSERT INTO detailbarangmasuk(NoFaktur, Kode_Barang, Nama_Barang, Jumlah, Harga, Subtotal) VALUES(?, ?, ?, ?, ?, ?)";
    PreparedStatement statDetail = conn.prepareStatement(sql);
    
    String updateStockSql = "UPDATE databarang SET Stok = Stok + ? WHERE Kode_Barang = ?";
    PreparedStatement updateStockStat = conn.prepareStatement(updateStockSql);
    ...
    private javax.swing.JButton bDST;
    ...
    private javax.swing.JTextField namaDST;
    private javax.swing.JTextField nmbarang;
    private javax.swing.JTable table;
    private javax.swing.JTextField tharga;
    private javax.swing.JTextField tidDST;
